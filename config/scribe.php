...
return [
    ...
    'title' => 'UAMD Portal API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'REST API për Portalin e Universitetit Aleksander Moisiu Durrës (UAMD). '
        . 'Të gjitha endpoint-et janë të prefixuara me /api/v1/.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            Kjo dokumentacion synon të ofrojë të gjithë informacionin e nevojshëm për të punuar me API-in tonë.

            <aside>Të gjitha kërkesat e mbrojtura kërkojnë një Bearer token të marrë nga <b>POST /api/v1/auth/login</b> ose OAuth me Google.</aside>
        INTRO,
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                'GET /docs', 'GET /docs.postman', 'GET /docs.openapi',
            ],
        ],
    ],
    ...
    'auth' => [
        ...
        // Most endpoints require auth; public ones are marked @unauthenticated.
        'default' => true,
        ...
        // Populate SCRIBE_AUTH_KEY in .env with a valid Sanctum token for live response examples.
        'use_value' => env('SCRIBE_AUTH_KEY'),

        'placeholder' => '{SANCTUM_TOKEN}',

        'extra_info' => 'Merr token-in duke bërë <b>POST /api/v1/auth/login</b> (pedagog/admin) ose OAuth me Google (student).',
    ],
